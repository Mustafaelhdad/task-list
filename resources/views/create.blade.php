...
@section('content')
    <div style="background: white; padding: 20px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <h1 style="font-size: 2.5em; color: #4CAF50; text-align: center; margin-bottom: 20px;">Create a New Task</h1>
        ...
        <form style="display: flex; flex-direction: column; gap: 15px;" action="{{ route('tasks.store') }}" method="POST">
            @csrf
            <div>
            ...
            <div>
                ...
                <textarea id="description" name="description"
                    style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px;" rows="3">{{ old('description') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea id="long_description" name="long_description"
                    style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px;" rows="4">{{ old('long_description') }}</textarea>
            </div>
